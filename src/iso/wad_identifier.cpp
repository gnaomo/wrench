...
static WadFileDescription WAD_FILE_TYPES[] = {
	...
	{"bonus" , Game::UYA    , WadType::BONUS      , 0x0c00}, // japan and korea
	...
	{"armor" , Game::DL     , WadType::ARMOR      , 0x0248}, // japan and korea
...
{
	// Some of the header sizes are different for the japanese and korean versions.
	if (region == Region::JAPAN || region == Region::KOREA) {
